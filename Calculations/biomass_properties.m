...
# Carbon mass balance
C = (s_gluc*6+s_urea*1+s_CSL*0.96)-(3+s_eth*2+s_acet*2+1);

# Hydrogen mass balance
H = (s_gluc*12+s_urea*4+s_CSL*2.94)-(8+s_eth*6+s_acet*4+2);

# Oxygen mass balance
O = (s_gluc*6+s_urea*1+s_CSL*1.41+2)-(3+s_eth*1+s_acet*2+2+1);

# Nitrogen mass balance
N = (s_urea*2+s_CSL*0.05);

# Phosphorus mass balance
P = s_CSL*0.03;

# Biomass in [Carbon, Hydrogen, Oxygen, Nitrogen, Phosphorus]
disp("Carbon, Hydrogen, Oxygen, Nitrogen, Phosphorus in Biomass")
Biomass = [C H O N P]
MW_b = 12*C+1*H+16*O+14*N+31*P
Density = 1.5 # g/ml
disp("In g/ml")
