...
S_available = 32692.2*10^6; # Διαθέσιμο υπόστρωμα τον χρόνο (g/year)
...
cost_urea = urea_y*urea_price; # Κόστος Ουρίας (euro/year)
cost_csl = csl_y*csl_price; # Κόστος CSL (euro/year)
income = P_y*glyc_price # Κέρδος (euro/year)
cost = cost_urea+cost_csl # Συνολικό κόστος (euro/year)
